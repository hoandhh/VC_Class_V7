        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    input_data += s
                    if dataset.count % 5 == 0:
                        text = GeminiApi.get_response(input_data)
                        # print(GeminiApi.get_response(input_data))
                        # print(input_data)
                        input_data = ""
            ...
            # Stream results
            if view_img:
                cv2.putText(im0, text, (50, 50), font, 1, (0, 255, 255), 2, cv2.LINE_4)
